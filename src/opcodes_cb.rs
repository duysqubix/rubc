...
pub fn init_opcodes_cb() -> OpCodeMap {
    phf::phf_map! {
        ...
        0x40u8 => |mb: &mut Motherboard, _value: u16| -> OpCycles {
            clear_bits!(mb.cpu.f, BIT_FLAGN);
            set_bits!(mb.cpu.f, BIT_FLAGH, BIT_FLAGZ);

            if is_bit_set(mb.cpu.b, 0) {
                clear_bits!(mb.cpu.f, BIT_FLAGZ);
            }
        ...
        // SET 0, D
        0xC2u8 => |mb: &mut Motherboard, _value: u16| -> OpCycles {
            mb.cpu.d |= 0x01;
            CYCLE_RETURN_8
        },

        // SET 0, E
        0xC3u8 => |mb: &mut Motherboard, _value: u16| -> OpCycles {
            mb.cpu.e |= 0x01;
            CYCLE_RETURN_8
        },

        // SET 0, H
        0xC4u8 => |mb: &mut Motherboard, _value: u16| -> OpCycles {
            mb.cpu.h |= 0x01;
            CYCLE_RETURN_8
        },
        ...
        // SET 0, (HL)
        0xC6u8 => |mb: &mut Motherboard, _value: u16| -> OpCycles {
            let hl = (mb.cpu.h as u16) << 8 | mb.cpu.l as u16;
            let mut value = memory_read(hl);
            value |= 0x01;
            memory_write(hl, value);
        ...
        // SET 1, D
        0xCAu8 => |mb: &mut Motherboard, _value: u16| -> OpCycles {
            mb.cpu.d |= 0x02;
            CYCLE_RETURN_8
        },
        ...
        // SET 1, H
        0xCCu8 => |mb: &mut Motherboard, _value: u16| -> OpCycles {
            mb.cpu.h |= 0x02;
            CYCLE_RETURN_8
        },

        // SET 1, L
        0xCDu8 => |mb: &mut Motherboard, _value: u16| -> OpCycles {
            mb.cpu.l |= 0x02;
            CYCLE_RETURN_8
        },

        // SET 1, (HL)
        0xCEu8 => |mb: &mut Motherboard, _value: u16| -> OpCycles {
            let hl = (mb.cpu.h as u16) << 8 | mb.cpu.l as u16;
            let mut value = memory_read(hl);
            value |= 0x02;
            memory_write(hl, value);
        ...
        // SET 2, D
        0xD2u8 => |mb: &mut Motherboard, _value: u16| -> OpCycles {
            mb.cpu.d |= 0x04;
            CYCLE_RETURN_8
        },

        // SET 2, E
        0xD3u8 => |mb: &mut Motherboard, _value: u16| -> OpCycles {
            mb.cpu.e |= 0x04;
            CYCLE_RETURN_8
        },

        // SET 2, H
        0xD4u8 => |mb: &mut Motherboard, _value: u16| -> OpCycles {
            mb.cpu.h |= 0x04;
            CYCLE_RETURN_8
        },
        ...
        // SET 2, (HL)
        0xD6u8 => |mb: &mut Motherboard, _value: u16| -> OpCycles {
            let hl = (mb.cpu.h as u16) << 8 | mb.cpu.l as u16;
            let mut value = memory_read(hl);
            value |= 0x04;
            memory_write(hl, value);
        ...
        // SET 3, D
        0xDAu8 => |mb: &mut Motherboard, _value: u16| -> OpCycles {
            mb.cpu.d |= 0x08;
            CYCLE_RETURN_8
        },

        // SET 3, E
        0xDBu8 => |mb: &mut Motherboard, _value: u16| -> OpCycles {
            mb.cpu.e |= 0x08;
            CYCLE_RETURN_8
        },

        // SET 3, H
        0xDCu8 => |mb: &mut Motherboard, _value: u16| -> OpCycles {
            mb.cpu.h |= 0x08;
            CYCLE_RETURN_8
        },

        // SET 3, L
        0xDDu8 => |mb: &mut Motherboard, _value: u16| -> OpCycles {
            mb.cpu.l |= 0x08;
            CYCLE_RETURN_8
        },

        // SET 3, (HL)
        0xDEu8 => |mb: &mut Motherboard, _value: u16| -> OpCycles {
            let hl = (mb.cpu.h as u16) << 8 | mb.cpu.l as u16;
            let mut value = memory_read(hl);
            value |= 0x08;
            memory_write(hl, value);
        ...
        // SET 4, B
        0xE0u8 => |mb: &mut Motherboard, _value: u16| -> OpCycles {
            mb.cpu.b |= 0x10;
            CYCLE_RETURN_8
        },
        ...
        // SET 4, E
        0xE3u8 => |mb: &mut Motherboard, _value: u16| -> OpCycles {
            mb.cpu.e |= 0x10;
            CYCLE_RETURN_8
        },

        // SET 4, H
        0xE4u8 => |mb: &mut Motherboard, _value: u16| -> OpCycles {
            mb.cpu.h |= 0x10;
            CYCLE_RETURN_8
        },
        ...
        // SET 4, (HL)
        0xE6u8 => |mb: &mut Motherboard, _value: u16| -> OpCycles {
            let hl = (mb.cpu.h as u16) << 8 | mb.cpu.l as u16;
            let mut value = memory_read(hl);
            value |= 0x10;
            memory_write(hl, value);
        ...
        // SET 5, B
        0xE8u8 => |mb: &mut Motherboard, _value: u16| -> OpCycles {
            mb.cpu.b |= 0x20;
            CYCLE_RETURN_8
        },
        ...
        // SET 5, D
        0xEAu8 => |mb: &mut Motherboard, _value: u16| -> OpCycles {
            mb.cpu.d |= 0x20;
            CYCLE_RETURN_8
        },

        // SET 5, E
        0xEBu8 => |mb: &mut Motherboard, _value: u16| -> OpCycles {
            mb.cpu.e |= 0x20;
            CYCLE_RETURN_8
        },

        // SET 5, H
        0xECu8 => |mb: &mut Motherboard, _value: u16| -> OpCycles {
            mb.cpu.h |= 0x20;
            CYCLE_RETURN_8
        },

        // SET 5, L
        0xEDu8 => |mb: &mut Motherboard, _value: u16| -> OpCycles {
            mb.cpu.l |= 0x20;
            CYCLE_RETURN_8
        },

        // SET 5, (HL)
        0xEEu8 => |mb: &mut Motherboard, _value: u16| -> OpCycles {
            let hl = (mb.cpu.h as u16) << 8 | mb.cpu.l as u16;
            let mut value = memory_read(hl);
            value |= 0x20;
            memory_write(hl, value);
        ...
        // SET 6, B
        0xF0u8 => |mb: &mut Motherboard, _value: u16| -> OpCycles {
            mb.cpu.b |= 0x40;
            CYCLE_RETURN_8
        },
        ...
        // SET 6, H
        0xF4u8 => |mb: &mut Motherboard, _value: u16| -> OpCycles {
            mb.cpu.h |= 0x40;
            CYCLE_RETURN_8
        },
        ...
        // SET 6, (HL)
        0xF6u8 => |mb: &mut Motherboard, _value: u16| -> OpCycles {
            let hl = (mb.cpu.h as u16) << 8 | mb.cpu.l as u16;
            let mut value = memory_read(hl);
            value |= 0x40;
            memory_write(hl, value);
        ...
        // SET 7, B
        0xF8u8 => |mb: &mut Motherboard, _value: u16| -> OpCycles {
            mb.cpu.b |= 0x80;
            CYCLE_RETURN_8
        },
        ...
        // SET 7, D
        0xFAu8 => |mb: &mut Motherboard, _value: u16| -> OpCycles {
            mb.cpu.d |= 0x80;
            CYCLE_RETURN_8
        },
        ...
        // SET 7, H
        0xFCu8 => |mb: &mut Motherboard, _value: u16| -> OpCycles {
            mb.cpu.h |= 0x80;
            CYCLE_RETURN_8
        },

        // SET 7, L
        0xFDu8 => |mb: &mut Motherboard, _value: u16| -> OpCycles {
            mb.cpu.l |= 0x80;
            CYCLE_RETURN_8
        },

        // SET 7, (HL)
        0xFEu8 => |mb: &mut Motherboard, _value: u16| -> OpCycles {
            let hl = (mb.cpu.h as u16) << 8 | mb.cpu.l as u16;
            let mut value = memory_read(hl);
            value |= 0x80;
            memory_write(hl, value);
